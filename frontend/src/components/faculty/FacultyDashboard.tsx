    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 flex items-center justify-center p-4">
      <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 w-full max-w-2xl text-center">
        ...
        <div className="flex items-center justify-center mb-8">
          <GraduationCap className="text-green-400 mr-3" size={48} />
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-300 text-lg">
            Bạn đã đăng nhập với quyền <span className="text-green-400 font-semibold">Giảng viên</span>
          </p>
        </div>
        ...
        <div className="bg-green-500/20 border border-green-500/30 rounded-lg p-6 mb-8">
          <h3 className="text-green-400 font-semibold text-xl mb-2">
            Trang Faculty đang phát triển
          </h3>
          <p className="text-gray-300">
            UI dashboard cho Faculty sẽ được hoàn thiện sau. 
