...
const mockContent: KnowledgeContent[] = [
    {
        ...
        description:
            "Tài liệu hướng dẫn chi tiết về lập trình hướng đối tượng với Java.",
        type: "pdf",
        subjectCode: "PRO192",
    ...
    },
    {
        ...
        description:
            "Tổng quan về các mô hình và quy trình trong phát triển phần mềm.",
        type: "pdf",
        subjectCode: "SWE101",
            ...
            case "approved":
                return (
                    <span
                        ...
                        style={{ backgroundColor: "#bbf7d0", color: "#166534" }} // xanh lá pastel + xanh lá đậm
                    >
                        <CheckCircle
    ...
    const handleBulkAction = (action: string) => {
        ...
        switch (action) {
            ...
            case "delete":
                if (
                    confirm(
                        `Bạn có chắc chắn muốn xóa ${selectedItems.length} nội dung đã chọn?`
                    )
                ) {
                    setContent((prev) =>
    ...
    return (
        <div className="min-h-screen bg-white p-6 text-black ">
            ...
            <div className="flex justify-between items-center mb-6">
                <div>
                    <h1 className="text-2xl font-bold text-black mb-1">Quản lý kho tri thức</h1>
                ...
                <div className="flex gap-2">
                    {selectedItems.length > 0 && (
                        <button
                            ...
                            className="flex items-center px-4 py-2 rounded-lg border border-yellow-400 bg-yellow-200 text-black shadow hover:bg-yellow-300 transition-colors"
                        >
                    ...
                    <button
                        className="bg-gray-900 hover:bg-gray-600 !text-white px-4 py-2 rounded-lg flex items-center gap-2 transition-colors border border-indigo-700"
                ...
                <Card>
                    <CardContent className="p-4">
                        <div
                            ...
                            style={{ backgroundColor: "#bbf7d0", color: "#166534" }} // xanh lá nhạt + xanh lá đậm
                        >
                            <CheckCircle className="h-4 w-4" style={{ color: "#166534" }} />
                            <span>Đã duyệt</span>
                        </div>

                        <p className="text-2xl font-bold mt-2">
                            {mockStats.approvedContent}
                        </p>
                    </CardContent>
                </Card>
            ...
            <Dialog open={showViewModal} onOpenChange={setShowViewModal}>
                <DialogContent className="!max-w-[50vw] h-[95vh]">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            {selectedContent?.subjectCode} - {selectedContent?.semester} | Tác
                            giả: {selectedContent?.createdBy}
                        </DialogDescription>
                    </DialogHeader>
                                ...
                                <div className="h-full bg-black rounded-lg overflow-hidden flex items-center justify-center">
                                    <div className="text-center text-white">
                                        ...
                                        <p className="text-sm opacity-75">
                                            Video player sẽ được hiển thị tại đây
                                        </p>
                                    </div>
                                </div>
                            ) : (
                        ...
                        <div className="grid grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <Select defaultValue={selectedContent?.subjectCode}>
                                    ...
                                    <SelectContent>
                                        <SelectItem value="PRO192">
                                            PRO192 - Lập trình hướng đối tượng
                                        </SelectItem>
                                        <SelectItem value="DBI202">
                                            DBI202 - Hệ quản trị CSDL
                                        </SelectItem>
                                        <SelectItem value="SWE101">
                                            SWE101 - Nhập môn Kỹ thuật phần mềm
                                        </SelectItem>
                                        <SelectItem value="CSD201">
...
function CreateContentForm({
    ...
    const [pdfFile, setPdfFile] = useState<{ file: File; url: string } | null>(
        null
    );
    ...
    const handleSubmit = () => {
        ...
        const selectedSubjectData = getSubjectsForSemester(selectedSemester).find(
            (s) => s.id === selectedSubject
        );

        const newContent: Omit<
            KnowledgeContent,
            "id" | "createdAt" | "updatedAt" | "viewCount" | "downloadCount"
        > = {
            title,
    ...
    return (
        <div className="space-y-4 max-h-[calc(90vh-120px)] overflow-y-auto pr-2">
                    ...
                    <div className="flex flex-wrap gap-1 p-2 border rounded-md min-h-[40px]">
                        ...
                        {selectedTags.length === 0 && (
                            <span className="text-muted-foreground text-sm">
                                Chọn tags từ danh sách bên dưới
                            </span>
                        )}
                    </div>
            ...
            <div className="flex justify-end gap-2 pt-4 border-t">
                ...
                <Button onClick={handleSubmit}>Tạo nội dung</Button>
            </div>
