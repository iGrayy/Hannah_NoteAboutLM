    ...
    <div className="min-h-screen bg-white p-6 text-black ">
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-black">Tinh chỉnh Hannah AI với dữ liệu giáo dục được tuyển chọn.</p>
        </div>
      </div>
        ...
        <div className="lg:col-span-2 space-y-6">
              ...
              <div className="border rounded-lg">
                <div className="flex items-center p-4 bg-blue-50">
                  <Checkbox
                    ...
                    className="mr-4"
                  />
                  <Database className="h-6 w-6 mr-4 text-black" />
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-black">{dataSources.knowledgeBase.description}</p>
                  </div>
                </div>
                ...
                <div className="border-t">
                  <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                    <TabsList className="grid w-full grid-cols-2">
                      <TabsTrigger
                        value="knowledge"
                        className="flex items-center gap-2 data-[state=active]:border data-[state=active]:shadow-md data-[state=active]:rounded-lg data-[state=active]:bg-white transition"
                      >
                    ...
                    <TabsContent value="knowledge" className="mt-4">
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center gap-4 p-3 bg-gray-50 rounded-lg">
                          ...
                          <span className="text-sm font-medium text-black">Lọc theo trạng thái:</span>
                              ...
                              <div key={semester.id} className="border rounded-lg bg-gray-50">
                                ...
                                >
                                  <div className="flex items-center gap-2">
                                    ...
                                    <span className="font-medium text-black">{semester.name}</span>
                      ...
                      <div className="border rounded-lg">
                        <div className="flex items-center p-4 bg-green-50">
                          <Checkbox
                            ...
                            className="mr-4"
                          />
                          <MessageSquare className="h-6 w-6 mr-4 text-black" />
                          <div className="flex-1">
                            <div className="flex items-center gap-2 mb-1">
                            ...
                            <p className="text-sm text-black">{dataSources.facultyResponses.description}</p>
                          </div>
                        </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription className="text-black">Thiết lập các tham số cơ bản cho quá trình tinh chỉnh.</CardDescription>
            </CardHeader>
        ...
        <div className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription className="text-black">Khởi động quá trình tinh chỉnh với dữ liệu và cấu hình đã chọn.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              {trainingStatus === "idle" && (
                <Alert>
                  <AlertTitle>Sẵn sàng bắt đầu</AlertTitle>
                  <AlertDescription className="text-black">Hệ thống đã sẵn sàng để bắt đầu quá trình huấn luyện.</AlertDescription>
                </Alert>
              )}
              ...
              {trainingStatus === "running" && (
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    <Label className="text-black">Đang huấn luyện</Label>
              ...
              {trainingStatus === "completed" && (
                <Alert variant="default" className="bg-green-50 border-green-200">
                  ...
                  <AlertTitle className="text-black">Huấn luyện hoàn thành</AlertTitle>
                  <AlertDescription className="text-black">Mô hình đã được tinh chỉnh thành công.</AlertDescription>
                </Alert>
              )}

              <Button
                className="bg-gray-900 hover:bg-gray-600 !text-white px-4 py-2 rounded-lg flex items-center gap-2 transition-colors border border-indigo-700 w-full"
...
function FacultyQACard({ qa, isSelected, onSelect, onTrain }: {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case 'completed': return 'text-black bg-green-50 border-green-200'
      case 'in_progress': return 'text-black bg-blue-50 border-blue-200'
      case 'failed': return 'text-black bg-red-50 border-red-200'
        ...
        <div className="flex-1 space-y-3">
          ...
          <div>
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-sm font-medium text-black">Câu hỏi đã chỉnh sửa:</span>
            </div>
            <p className="text-sm font-medium text-black bg-blue-50 p-3 rounded-lg">
              {qa.question}
            </p>
            {qa.originalQuestion && (
          ...
          <div>
            <div className="flex items-center gap-2 mb-2">
              <MessageSquare className="h-4 w-4 text-black" />
              <span className="text-sm font-medium text-black">Trả lời:</span>
            </div>
            <p className="text-sm text-black bg-green-50 p-3 rounded-lg">
              {qa.answer}
            </p>
          </div>
          ...
          {/* Thông báo Lỗi */}
          {qa.errorMessage && (
            <div className="text-xs text-black bg-red-50 p-2 rounded">
        ...
        <div className="flex items-start gap-3 flex-1">
          ...
          <div className="flex-1">
            ...
            {subject.errorMessage && (
              <div className="text-xs text-black mt-1 bg-red-50 p-2 rounded">
                {subject.errorMessage}
              </div>
            )}
          </div>
    ...
    <div className="border rounded-lg">
      <div className="flex items-center p-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-xs text-black mt-1">Định dạng: {source.format}</p>
        </div>
